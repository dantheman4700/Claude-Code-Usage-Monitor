...
/// For Codex, Antigravity, and Cursor, `percent` = None uses a provider placeholder badge.
pub fn create_icon(kind: TrayIconKind, percent: Option<f64>) -> HICON {
    ...
    let text_col = match kind {
        ...
        TrayIconKind::Codex if percent.unwrap_or(0.0) >= 90.0 => Color::from_hex("#10A37F"),
        ...
        TrayIconKind::Cursor if percent.unwrap_or(0.0) >= 90.0 => Color::from_hex("#111111"),
