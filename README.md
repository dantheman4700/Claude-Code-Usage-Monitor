...
cap, credits), or every provider as bars — drawn as big text over a gauge, a ring, a bar, or a number, with the
percent or the icon's own one-to-three character label as the text (so several icons can be told apart at a
glance), showing what is used or what is left, in each provider's own colour
(or monotone, or a colour you pick), and tinted amber and red at your warning
lines. Add as many icons as you like,
